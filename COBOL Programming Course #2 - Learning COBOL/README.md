# קורס תכנות COBOL #2 - לימוד COBOL

פרויקט זה הוא סט של חומרי הדרכה ומעבדות לקורס ברמת "לימוד COBOL" על COBOL. נעשה שימוש בכלי צד-לקוח חינמיים וזמינים לציבור כדי לתקשר עם סביבת המיינפריים, מה שמאפשר למשתתפים למנף בקלות טכנולוגיות אלו לאחר הקורס.
...
- הנכס PDF של קורס תכנות COBOL #2 - לימוד COBOL מכיל את הוראות הקורס.
...
`Front_Matter.tex` מכיל את התוכן שלפני תוכן העניינים. `COBOL Programming Course #2 - Learning COBOL.md` מכיל את הגוף. הפקודה משלבת את השניים, יוצרת את מספרי הסעיפים ותוכן העניינים עבור הגוף, ומוציאה את `COBOL Programming Course #2 - Learning COBOL.pdf`
